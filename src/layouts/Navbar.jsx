...
const Navbar = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            // Don't update scroll state when search is active
    ...
    }, [searchActive]); // Add searchActive as dependency
    ...
    // Search functionality from CollectionsPage
    const performSearch = useCallback(async (query) => {
        ...
        try {
            ...
            url.searchParams.append('pageSize', '8'); // Limit results for search preview
    ...
    // Calculate navbar styling - force full width when search is active
    ...
    return (
        <>
            ...
            <header
                className={`
                    ${shouldShowRoundedNavbar
                        ? 'fixed top-4 left-1/2 transform -translate-x-1/2 z-50'
                        : `bg-nav-dark bg-blac relativ absolut z-[999999999999999999999999999999] w-full ${location.pathname === '/' ? "absolute" : "relative"}`
                    }
            ...
            >
                <nav className={`
                    ...
                    ${shouldShowRoundedNavbar ? 'mx-auto px-6' : 'container'} 
                    ${shouldShowRoundedNavbar
